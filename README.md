...
This project is the users microservice built on Node.js, Express.
...
- **SDBM database**: [PostgreSQL](https://www.postgresql.org/) object data modeling using [Sequelize](https://sequelize.org)
